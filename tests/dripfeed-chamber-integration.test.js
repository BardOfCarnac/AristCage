...
assert.ok(state.geometry.aperture.top >= rail.rect.bottom + 7, 'selected grid line must clear the fixed title rail');
assert.ok(state.geometry.aperture.top < utility.rect.bottom, 'foreground controls must be allowed to float over the upper aperture');
