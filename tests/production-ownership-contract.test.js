...
assert.match(inventory, /ordinary RedWire canvas baseline is \*\*six mounted canvases\*\*/,
  "The baseline canvas count must be explicit.");
assert.match(inventory, /Heavy mist may create one mounted/, "Conditional compositor resources must be disclosed.");

console.log("Production ownership contract passed: legacy viewers are archived, active owners remain explicit, and the baseline resource ledger is enforceable.");
